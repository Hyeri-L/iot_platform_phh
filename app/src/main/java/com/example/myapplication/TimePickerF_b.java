...
public class TimePickerF_b extends DialogFragment implements TimePickerDialog.OnTimeSetListener {
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        ...
        Intent intent = new Intent(getContext(), AlertReceiver_b.class);//동작안함
